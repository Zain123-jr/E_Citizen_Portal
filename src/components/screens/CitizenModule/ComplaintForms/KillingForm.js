...
const KillingFormSchema = Yup.object().shape({
            ...
            <ScrollView>
                ...
                <View>
                    <Formik initialValues={{
                        ...
                        validationSchema={KillingFormSchema}
                                    ...
                                    <View style={styles.formContainer}>
                                        ...
                                        <View style={{ borderColor: '#ccc', top: -6, borderWidth: 2, borderTopWidth: 0, borderLeftWidth: 0, borderRightWidth: 0 }} >
                                            ...
                                            >
                                                ...
                                                <Picker.Item style={styles.item} label="Murder" value="Murder" />
                                                <Picker.Item style={styles.item} label="Custodial Death" value="Custodial Death" />
                                                <Picker.Item style={styles.item} label="Target Killing" value="Target Killing" />
                                            </Picker>
