...
const RobberyFormSchema = Yup.object().shape({
            ...
            <ScrollView>
                ...
                <View>
                    <Formik initialValues={{
                        ...
                        validationSchema={RobberyFormSchema}
                                    ...
                                    <View style={styles.formContainer}>
                                        ...
                                        <View style={{ borderColor: '#ccc', top: -6, borderWidth: 2, borderTopWidth: 0, borderLeftWidth: 0, borderRightWidth: 0 }} >
                                            ...
                                            >
                                                ...
                                                <Picker.Item style={styles.item} label="Armed Robbery" value="Armed Robbery" />
                                                <Picker.Item style={styles.item} label="CarJacking" value="CarJacking" />
                                                <Picker.Item style={styles.item} label="Bank Robbery" value="Bank Robbery" />
                                                <Picker.Item style={styles.item} label="Home Invasion" value="Home Invasion" />
                                            </Picker>
