...
const MissingPersonFormSchema = Yup.object().shape({
            ...
            <ScrollView>
                ...
                <View>
                    <Formik initialValues={{
                        ...
                        validationSchema={MissingPersonFormSchema}
                                    ...
                                    <View style={styles.formContainer}>
                                        ...
                                        <View style={{ borderColor: '#ccc', top: -6, borderWidth: 2, borderTopWidth: 0, borderLeftWidth: 0, borderRightWidth: 0 }} >
                                            ...
                                            >
                                                ...
                                                <Picker.Item style={styles.item} label="Endangered Missing" value="Endangered Missing" />
                                                <Picker.Item style={styles.item} label="Involuntary Missing" value="Involuntary Missing" />
                                                <Picker.Item style={styles.item} label="Voluntary Missing" value="Voluntary Missing" />
                                            </Picker>
